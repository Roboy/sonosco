...
from models.deepspeech2 import DeepSpeech, supported_rnns
...
parser.add_argument('--max-norm', default=800, type=int, help='Norm cutoff to prevent explosion of gradients')
...
if __name__ == '__main__':
    ...
    loss_results, cer_results, wer_results = torch.Tensor(args.epochs), torch.Tensor(args.epochs), \
    ...
    if args.continue_from:  # Starting from previous model
        ...
        model = DeepSpeech(rnn_hid_size=args.hidden_size,
    ...
    train_dataset = AudioDataset(audio_conf=audio_conf, manifest_filepath=args.train_manifest, labels=labels,
                                       normalize=False, augment=args.augment)
    test_dataset = AudioDataset(audio_conf=audio_conf, manifest_filepath=args.val_manifest, labels=labels,
